  ...
  try {
    ...
    if (text) {
      try {
        ...
        // Only surface a string message; an object/array message would break the Promise<string>
        // contract and crash React's render, so fall through to the status-aware fallback.
